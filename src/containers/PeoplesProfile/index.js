...
class PeoplesProfile extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <View
        ...
        <ButtonView
          ...
          onPress={() =>
            this.props.navigation.navigate('peoplesFollowing', {
              user_id: userItem.id,
              selectedTab: 1,
            })
          }>
    ...
    return (
      <View
        ...
        <ButtonView
          ...
          onPress={() =>
            this.props.navigation.navigate('peoplesGallery', {
              user_id: userItem.id,
            })
          }>
          <Text
        ...
        <ButtonView
          ...
          onPress={() =>
            this.props.navigation.navigate('testimony', {
  ...
  render() {
    ...
    console.log(this.state.video, 'checkk');
    ...
    return (
      <ImageBackground style={styles.container} source={Images.homeBackground}>
        ...
        />
        <FlatList
          data={_.isEmpty(this.state.postData) ? [] : [this.state.postData[0]]}
...
export default connect(mapStateToProps, actions)(PeoplesProfile);
