    ...
    return (
      <View>
        <View
          ...
          <Text color="black" size="small" type="regular">
            Hourly Rate {userItem?.hourly_rate}$
          </Text>
        </View>
        <FlatList
          data={userItem?.schedules}
        ...
        <ButtonView
          ...
          onPress={() =>
            this.props.navigation.navigate('BookSession', {
              name: userItem.name,
              hoursRate: userItem.hourly_rate,
              image: userItem.image,
              id: userItem.id,
            })
          }>
...
export default connect(mapStateToProps, actions)(TherapistProfile);
