...
import {createStripeCusRequest} from '../../actions/StripeActions';
...
class CompleteProfile extends Component {
  constructor(props) {
    super(props);
    //  const {user_id, first_name, last_name} = this.props.route.params;
  ...
  _onSubmit = () => {
    ...
    if (this._validateForm() && !isTherapist) {
      ...
      this.props.createStripeCusRequest(payload, res => {
        if (res) {
          this.setState({stripe_id: res});
          const formData = new FormData();
          formData.append('first_name', first_name);
          formData.append('last_name', last_name);

          formData.append('stripe_id', res);
    ...
    } else if (this._validateForm() && isTherapist) {
      const {
        first_name,
        last_name,
        dob,
  ...
  render() {
    ...
    console.log(this.state.profilePicture, 'checkkkk');
    return (
        ...
        <ScrollView>
          ...
          <View
            ...
            <ButtonView
              ...
              <Image
                source={isTherapist ? Images.checkbox_tick : Images.checkbox}
