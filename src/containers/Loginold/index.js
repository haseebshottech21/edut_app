  ...
  renderLogo() {
    return (
      <View
        ...
        <Image source={Images.spBackground} style={AppStyles.logoImage} />
      </View>
    );
  }
  ...
  renderSignupBtn() {
    return (
      <View
        ...
        <ButtonView onPress={() => this.props.navigation.navigate('signup1')}>
    ...
    return (
      <View
        ...
        <ScrollView
          ...
          <CustomNavbar title="test" titleColor="black" />
          {this.renderLogo()}
